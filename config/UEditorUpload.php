...
*/
    'core' => [
        ...
        // 阿里OSS配置, 若mode='alioss', 以下必填
        'alioss' => [
            'accessKeyId' => env('OSSKEYID', 'RhZDRqQRmJbm5Npl'),
            'accessKeySecret' => env('OSSKEYSECRET', '5lt3BGIQukR7V6fNKqeJPk7pxdALXc'),
            'endpoint' => env('OSSPOINT', 'oss-cn-beijing.aliyuncs.com'),
            'bucket' => env('OSSBUCKET', 'outdoors'),
        ]
    ],
    /**
